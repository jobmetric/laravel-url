...
return [
    ...
    */
    ...
    "rule" => [
        "exist" => "آدرس :field از قبل وجود دارد.",
    ],
    ...
    "fields" => [
        "slug" => [
            ...
            "description" => "'نامک' یک نسخه از نام است که برای نشانی وب مناسب است. معمولا با حروف کوچک بوده و تنها شامل حروف،‌ ارقام و خط تیره است.",
        ],
    ],
